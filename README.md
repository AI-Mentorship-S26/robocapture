...
Boom! You’re all set hardware wise. You now need to put it all in a robot. What I did for that was head to the makerspace and grab old robot chassis that were used for combat bots but were thrown away, you can probably do something like that.
