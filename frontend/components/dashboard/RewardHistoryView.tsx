  ...
  return (
    <div className="rounded-xl border border-white/[0.06] bg-white/[0.02] backdrop-blur-sm flex flex-col">
      <div className="px-4 py-3 border-b border-white/[0.05] flex items-center justify-between">
        <span className="text-[10px] font-semibold text-white/25 tracking-widest uppercase">Approval Rate History</span>
      ...
      <div className="p-5 flex flex-col gap-3">
        ...
        <div className="mt-2 flex flex-col gap-1">
          <div className="flex items-center gap-3 px-1 pb-1 border-b border-white/[0.04]">
            ...
            <span className="text-[9px] text-white/20 uppercase tracking-widest flex-1">Approval</span>
