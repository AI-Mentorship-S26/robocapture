  ...
  return (
    <aside className="w-64 shrink-0 flex flex-col border-l border-white/[0.06] bg-[#0D0D10]/50">
      <div className="flex items-center justify-between px-4 py-3 border-b border-white/[0.05]">
        <span className="text-[10px] font-semibold text-white tracking-widest uppercase">History</span>
        <span className="font-mono text-[11px] text-white">{history.length} frames</span>
      </div>
      ...
      <div className="border-t border-white/[0.06] px-4 py-4 shrink-0">
        <p className="text-[10px] font-semibold text-white tracking-widest uppercase mb-3">Rolling Approval Rate</p>
        <RewardChart data={rewardData} height={64} cellOpacityRange={[0.2, 0.5]} barRadius={2} />
        <div className="flex justify-between mt-1">
          <span className="font-mono text-[9px] text-white">early</span>
