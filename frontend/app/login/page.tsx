      ...
      <div className="relative z-10 w-full max-w-sm mx-4">
        ...
        >
          ...
          <div className="text-center mb-7">
            ...
            <p className="text-xs text-white mt-1 tracking-widest uppercase">
          ...
          {mode === "login" && (
            <form onSubmit={handleLogin} className="flex flex-col gap-4">
              <div>
                <label className="block text-xs font-medium text-white mb-1.5 uppercase tracking-wider">
                  Email
                </label>
                <input
                  type="email"
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <button
                    ...
                    className="absolute inset-y-0 right-0 pr-3 flex items-center text-white hover:text-white transition-colors cursor-pointer"
                  >
          ...
          {mode === "forgot" && (
            <form onSubmit={handleForgotPassword} className="flex flex-col gap-4">
              ...
              <button
                ...
                className="text-xs text-white hover:text-white transition-colors cursor-pointer text-center"
              >
                ← Back to sign in
              </button>
            </form>
            ...
            <>
              <div className="relative my-6">
                ...
                <div className="relative flex justify-center">
                  <span className="px-3 text-[11px] text-white" style={{ background: "rgba(15,15,20,0.85)" }}>
                    or continue with
                  </span>
                </div>
              </div>
              ...
              <div className="flex flex-col gap-2.5">
                <button
                  ...
                  disabled={loading}
                  className="w-full flex items-center justify-center gap-2.5 py-2.5 rounded-lg bg-white/[0.04] border border-white/[0.08] text-white text-sm font-medium hover:bg-white/[0.08] hover:text-white disabled:opacity-40 transition-all cursor-pointer"
                >
