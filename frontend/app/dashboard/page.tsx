...
import {
  NavView, RLModel, FrameAction, WsStatus,
  GalleryImage, HistoryEntry, StateVector,
  SEED_HISTORY, SEED_REWARD_HISTORY,
...
// Pi WebSocket URL — set NEXT_PUBLIC_PI_WS_URL in .env.local to override
...
export default function DashboardPage() {
  ...
  const sendAction = useCallback(async (action: "+R" | "-P" | "skip") => {
